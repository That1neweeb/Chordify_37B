...
function BasicCard({ icon, title, description, type }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="bg-[#27231B] h-[250px] w-[400px] rounded-2xl flex flex-col justify-center items-center gap-4 hover:bg-[#2B271E] hover:scale-105 transition-all duration-300 cursor-pointer"
    >

...
//     try {
//         const products = await Product.getApproved();
//         res.json(products);
//     } catch (err) {
...
//     try {
//         const products = await Product.getPending();
//         res.json(products);
//     } catch(err) {
//         console.log("Database error : " + err);
//         res.status(500).send("Database error");
...
//     try {
//         const { id } = req.params;
//         await Product.updateStatus(id, "approved");
...
//     try {
//         const { id } = req.params;
//         await Product.updateStatus(id, "rejected");
...
// // Get rejected products (for checking)
// async function getRejectedProducts(req, res) {
//     try {
//         const products = await Product.getRejected();
//         res.json(products);
//     } catch(err) {
//         console.log("Database error: " + err);
//         res.status(500).send("Database error");
